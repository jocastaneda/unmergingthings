...
class Ivole_Review_Reminder_Settings {
    ...
    protected function init_settings() {
        $language_desc = sprintf( __( 'Choose language that will be used for different elements of emails and review forms. If your language is not in the list, submit a translation by filling out %1$sthis form%2$s. Your translation will added with the next update of the plugin.', IVOLE_TEXT_DOMAIN ), '<a href="https://goo.gl/forms/8D4poyIBRq2MtWEP2" target="_blank">', '</a>' );
        ...
        $available_languages = array(
            ...
            'KA'  => __( 'Georgian', IVOLE_TEXT_DOMAIN ),
        ...
        $this->settings = array(
            array(
                ...
                'type'  => 'title',
                'desc'  => sprintf( __( 'Configure the plugin to use %1$sCR (Customer Reviews)%2$s service for sending automatic follow-up emails (reminders) that gather shop and product reviews. Review reminders are sent via an independent service because people commonly consider reviews managed by shops themselves to be biased or fake. Independent collection of customer feedback also enables other optional features such as trust badges or verification of reviews.', IVOLE_TEXT_DOMAIN ), '<a href="https://www.cusrev.com/business/" target="_blank" rel="noopener noreferrer">', '</a>' ) . '<br><br>' . sprintf( __( 'Before enabling this feature you MUST update your terms and conditions and make sure that your customers consent to receive an invitation to review their order. Depending on the location of your customers, it might also be necessary to receive an explicit consent to send review reminders. In this case, it is mandatory to enable the \'Customer Consent\' option below. By enabling and using this service, you agree to the %1$sterms and conditions%2$s.', IVOLE_TEXT_DOMAIN ), '<a href="https://www.cusrev.com/terms.html" target="_blank">', '</a>' ),
                'id'    => 'ivole_options'
            ),
            array(
            ...
            array(
                'title'   => __( 'Enable for Guests', IVOLE_TEXT_DOMAIN ),
                'desc'    => __( 'Enable sending of review reminders to customers who place orders without an account (guest checkout). It is recommended to enable this checkbox, if you allow customers to place orders without creating an account on your site.', IVOLE_TEXT_DOMAIN ),
            ...
            array(
                ...
                'desc'    => sprintf( __( 'Enable manual sending of follow-up emails with a reminder to submit a review. Manual reminders can be sent for completed orders from %1$sOrders%2$s page after enabling this option.', IVOLE_TEXT_DOMAIN ), '<a href="' . admin_url( 'edit.php?post_type=shop_order' ) . '">', '</a>' ),
            ...
            array(
                'title'   => __( 'Customer Consent Text', IVOLE_TEXT_DOMAIN ),
                'desc'    => __( 'Text of the message shown to customers next to the consent checkbox on the checkout page.', IVOLE_TEXT_DOMAIN ),
            ...
            array(
                ...
                'type'  => 'title',
                'desc'  => sprintf( __( 'Adjust template of the email that will be sent to customers. If you enable <b>advanced</b> email templates in your account on %1$sCR website%2$s, they will <b>override</b> the email template below.', IVOLE_TEXT_DOMAIN ), '<a href="https://www.cusrev.com/login.html" target="_blank" rel="noopener noreferrer">', '</a>' ),
            ...
            array(
                ...
                'type'  => 'title',
                'desc'  => sprintf( __( 'Adjust template of the aggregated review forms that will be created and sent to customers by CR. Modifications will be applied to the next review form created after saving settings. If you enable <b>advanced</b> form templates in your account on %1$sCR website%2$s, they will <b>override</b> the settings below.', IVOLE_TEXT_DOMAIN ), '<a href="https://www.cusrev.com/login.html" target="_blank" rel="noopener noreferrer">', '</a>' ),
            ...
            array(
                ...
                'default' => 'no',
                'desc'    => __( 'Enable this option if you would like to make it mandatory for your customers to write something in their review. This option applies only to aggregated review forms.', IVOLE_TEXT_DOMAIN )
            ),
            array(
                ...
                'default' => 'no',
                'desc'    => sprintf( __( 'Enable attachment of pictures and videos on aggregated review forms. Uploaded media files are stored on Amazon S3. The storage is free and sponsored by professional licenses. This option applies only to aggregated review forms. If you would like to enable attachment of pictures to reviews submitted on WooCommerce product pages, this can be done %1$shere%2$s.', IVOLE_TEXT_DOMAIN ), '<a href="' . admin_url( 'admin.php?page=ivole-reviews-settings&tab=review_extensions' ) . '">', '</a>' )
            ),
            array(
